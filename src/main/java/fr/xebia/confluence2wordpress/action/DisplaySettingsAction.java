 ...
 */
public class DisplaySettingsAction extends ConfluenceActionSupport {
    ...
    public DisplaySettingsAction(UserManager userManager, PluginSettingsFactory pluginSettingsFactory) {
        super();
    ...
    public String execute() throws Exception {
        ...
        wordpressXmlRpcUrl = (String) pluginSettings.get("fr.xebia.confluence2wordpress:wordpressXmlRpcUrl");
        wordpressUserName = (String) pluginSettings.get("fr.xebia.confluence2wordpress:wordpressUserName");
        wordpressPassword = (String) pluginSettings.get("fr.xebia.confluence2wordpress:wordpressPassword");
        wordpressBlogId = (String) pluginSettings.get("fr.xebia.confluence2wordpress:wordpressBlogId");
        return SUCCESS;
    }
