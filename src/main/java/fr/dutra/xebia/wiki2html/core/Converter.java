...
import fr.dutra.xebia.wiki2html.core.visitors.CdataStripper;
import fr.dutra.xebia.wiki2html.core.visitors.CodeSnippetConverter;
import fr.dutra.xebia.wiki2html.core.visitors.CssClassNameCleaner;
import fr.dutra.xebia.wiki2html.core.visitors.EmptySpanStripper;
import fr.dutra.xebia.wiki2html.core.visitors.UrlConverter;
...
public class Converter {
    ...
    public String convert(Page page, ConverterOptions options) {
        ...
        return postConvert(confluenceHtml, options);
    }
    ...
    protected String convertInternal(PageContext pageContext, String wiki, @SuppressWarnings("unused") ConverterOptions options) {
         ...
         * fr/dutra/xebia/wiki2html/rpc/Wiki2HtmlRpcImpl$1, and the class loader (instance of org/apache/catalina/loader/WebappClassLoader)
    ...
    protected String postConvert(String confluenceHtml, ConverterOptions options) {
        ...
        return serialize(body, cleanerProps);
    }
