 ...
 */
package fr.dutra.confluence2wordpress.core.labels;
...
public class DefaultPageLabelsSynchronizer implements PageLabelsSynchronizer {
    ...
    /* (non-Javadoc)
     * @see fr.dutra.confluence2wordpress.core.labels.PageLabelsSynchronizer#tagNamesToPageLabels(com.atlassian.confluence.core.ContentEntityObject, fr.dutra.confluence2wordpress.core.metadata.Metadata)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see fr.dutra.confluence2wordpress.core.labels.PageLabelsSynchronizer#pageLabelsToTagNames(com.atlassian.confluence.core.ContentEntityObject, fr.dutra.confluence2wordpress.core.metadata.Metadata)
     */
    @Override
